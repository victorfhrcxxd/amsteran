...
public class HwidLog
{
	...
	private static final Logger _log = Logger.getLogger(HwidLog.class.getName());
	...
	public static void auditGMAction(String gmName, String action, String params)
	{
		...
		{
			save.write(Util.formatDate(new Date(), "dd/MM/yyyy H:mm:ss") + " >>> HWID: [" + gmName + "] >>> Jogador  [" + action + "]\r\n");
		}
		catch (IOException e)
		{
