...
public class DoorStatusUpdate extends L2GameServerPacket
{
	...
	{
		_door = door;
		_showHp = door.getCastle() != null && door.getCastle().getSiege().isInProgress() || FOSEvent.isStarted() && FOSConfig.FOS_DOORS_ATTACKABLE.contains(Integer.valueOf(door.getDoorId()));
	}
