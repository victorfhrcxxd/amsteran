...
public class EtcStatusUpdate extends L2GameServerPacket
{
	...
	protected void writeImpl()
	{
		...
		writeD((((_activeChar.getExpertiseWeaponPenalty() || _activeChar.getExpertiseArmorPenalty() > 0) || _activeChar.getMasteryPenalty() > 0) || _activeChar.getMasteryWeapPenalty() > 0 || _activeChar.getClassArmorPenalty() > 0 || _activeChar.getClassWeaponPenalty() > 0) ? 1 : 0);
