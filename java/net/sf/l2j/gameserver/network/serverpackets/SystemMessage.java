...
public final class SystemMessage extends L2GameServerPacket
{
	...
	public static final SystemMessage sendCustomString(final String text)
	{
		if (text == null)
			throw new NullPointerException();
		
		final SystemMessage sm = SystemMessage.getSystemMessage(SystemMessageId.T1);
		sm.addString(text);
		return sm;
	}
	
	public static final SystemMessage sendHideCustomString(final String text)
	{
		if (text == null)
			throw new NullPointerException();
		
		final SystemMessage sm = SystemMessage.getSystemMessage(SystemMessageId.K1);
		sm.addString(text);
		return sm;
	}
