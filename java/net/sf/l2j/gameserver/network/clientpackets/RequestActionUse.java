...
public final class RequestActionUse extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		switch (_actionId)
		{
			...
			case 1090: // Custom Action - AutoFarm
			{
				final IVoicedCommandHandler handler = VoicedCommandHandler.getInstance().getHandler("autofarm");
				if (handler != null)
					handler.useVoicedCommand("autofarm", activeChar, null);
				break;
			}
			
			case 1091: // Custom Action - Menu
			{
				final IVoicedCommandHandler handler = VoicedCommandHandler.getInstance().getHandler("menu");
				if (handler != null)
					handler.useVoicedCommand("menu", activeChar, null);
				break;
			}
