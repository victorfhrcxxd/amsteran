...
public final class RequestMagicSkillUse extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (skill != null)
		{
			...
			// ranked skin armor
			ItemInstance slot = activeChar.getInventory().getPaperdollItem(Inventory.PAPERDOLL_CHEST);
			if (skill.getSkillType() == L2SkillType.RANK_DIAMOND && slot == null || skill.getSkillType() == L2SkillType.RANK_DIAMOND && !slot.isArmor())
			{
				activeChar.sendMessage("Armor chest must be equiped!");
				return;
			}
