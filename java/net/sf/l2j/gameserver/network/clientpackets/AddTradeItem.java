		...
		if (item != null)
		{
			...
			if (itemInstance.isAugmented())
			{
				...
				if (augSkill != null && augSkill.isPassive())
					partner.sendMessage(String.format("%s - %s ", itemInstance.getName(), "Passive " + augSkill.getName()));
				else if (augSkill != null && augSkill.isActive())
					partner.sendMessage(String.format("%s - %s ", itemInstance.getName(), "Active " + augSkill.getName()));
				else if (augSkill != null && augSkill.isChance())
					partner.sendMessage(String.format("%s - %s ", itemInstance.getName(), "Chance " + augSkill.getName()));
				else
