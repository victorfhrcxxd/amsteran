...
public class MultisellData
{
	...
	private void parse()
	{
		...
		if (Config.LOAD_CUSTOM_MULTISELLS)
		{
			...
			hashFiles("multisell/custom/armors", files);
			hashFiles("multisell/custom/weapons", files);
			hashFiles("multisell/custom/jewels", files);
			hashFiles("multisell/custom/misc", files);
			hashFiles("multisell/custom/donate", files);
			hashFiles("multisell/custom/special", files);
		}
