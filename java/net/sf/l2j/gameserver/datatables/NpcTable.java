									...
									if ("category".equalsIgnoreCase(dropCat.getNodeName()))
									{
										...
										for (Node item = dropCat.getFirstChild(); item != null; item = item.getNextSibling())
										{
											if ("drop".equalsIgnoreCase(item.getNodeName()))
											{
												...
												if (attrs.getNamedItem("enchantMin") != null)
													dropDat.setMinEnchant(Integer.parseInt(attrs.getNamedItem("enchantMin").getNodeValue())); 
												if (attrs.getNamedItem("enchantMax") != null)
													dropDat.setMaxEnchant(Integer.parseInt(attrs.getNamedItem("enchantMax").getNodeValue())); 
												if (attrs.getNamedItem("enchantSuccess") != null)
													dropDat.setEnchantSucess(Integer.parseInt(attrs.getNamedItem("enchantSuccess").getNodeValue())); 
