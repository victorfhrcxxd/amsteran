...
public abstract class AbstractOlympiadGame
{
	...
	protected static SystemMessage checkDefaulted(L2PcInstance player)
	{
		...
		if (MultiTvTEvent.isPlayerParticipant(player.getObjectId()) || CTFEvent.isPlayerParticipant(player.getObjectId()) || FOSEvent.isPlayerParticipant(player.getObjectId()) || DMEvent.isPlayerParticipant(player.getObjectId()) || LMEvent.isPlayerParticipant(player.getObjectId()) || TvTEvent.isPlayerParticipant(player.getObjectId()) || KTBEvent.isPlayerParticipant(player.getObjectId())  || player.isInArenaEvent())
		{
