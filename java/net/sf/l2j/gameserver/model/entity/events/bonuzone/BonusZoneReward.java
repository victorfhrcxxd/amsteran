...
public class BonusZoneReward
{
	protected static final Logger _log = Logger.getLogger(BonusZoneReward.class.getName());

	protected BonusZoneReward()
	{
	}
	...
	{
		for (RewardHolder reward : Config.BONUS_ZONE_EVENT_REWARDS)
		{
	...
	public static final BonusZoneReward getInstance()
	{
	...
	{
		protected static final BonusZoneReward _instance = new BonusZoneReward();
	}
}