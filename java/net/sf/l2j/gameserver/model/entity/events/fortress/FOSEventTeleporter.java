...
public class FOSEventTeleporter implements Runnable
{
	 ...
	 * @param adminRemove
	 */
	public FOSEventTeleporter(L2PcInstance playerInstance, int[] coordinates, boolean fastSchedule, boolean adminRemove)
	{
	...
	public void run()
	{
		...
		if ((FOSConfig.FOS_EVENT_EFFECTS_REMOVAL == 0) || ((FOSConfig.FOS_EVENT_EFFECTS_REMOVAL == 1) && ((_activeChar.getTeam() == 0) || (_activeChar.isInDuel() && (_activeChar.getDuelState() != Duel.DUELSTATE_INTERRUPTED)))))
