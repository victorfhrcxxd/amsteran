...
public class Siege implements Siegable
{
	...
	public void registerAttacker(L2PcInstance player)
	{
		...
		{
			player.sendMessage("Event currently unavailable, please wait!");
			return;
		}
	...
	private void setNextSiegeDate()
	{
		...
		{
			case 1: // Gludio
				siegeDate.set(Calendar.HOUR_OF_DAY, SiegeManager.SIEGE_HOUR_GLUDIO);
				break;
			case 2: // Dion
				siegeDate.set(Calendar.HOUR_OF_DAY, SiegeManager.SIEGE_HOUR_DION);
				break;
			case 3: // Giran
				siegeDate.set(Calendar.HOUR_OF_DAY, SiegeManager.SIEGE_HOUR_GIRAN);
				break;
			case 4: // Oren
				siegeDate.set(Calendar.HOUR_OF_DAY, SiegeManager.SIEGE_HOUR_OREN);
				break;
			case 5: // Aden
				siegeDate.set(Calendar.HOUR_OF_DAY, SiegeManager.SIEGE_HOUR_ADEN);
				break;
			case 6: // Innadril/Heine
				siegeDate.set(Calendar.HOUR_OF_DAY, SiegeManager.SIEGE_HOUR_INNADRIL);
				break;
			case 7: // Goddard
				siegeDate.set(Calendar.HOUR_OF_DAY, SiegeManager.SIEGE_HOUR_GODDARD);
				break;
			case 8: // Rune
				siegeDate.set(Calendar.HOUR_OF_DAY, SiegeManager.SIEGE_HOUR_RUNE);
				break;
			case 9: // Schuttgart
				siegeDate.set(Calendar.HOUR_OF_DAY, SiegeManager.SIEGE_HOUR_SCHUTTGART);
				break;
