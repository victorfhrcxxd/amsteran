...
import net.sf.l2j.gameserver.model.entity.events.fortress.FOSEventTeam;
...
import net.sf.l2j.gameserver.model.entity.events.multiteamvsteam.MultiTvTEventTeam;
...
public class L2CubicInstance
{
	...
	public void getCubicTarget()
	{
		try
		{
			...
			// TvT event targeting
			if (MultiTvTEvent.isStarted() && MultiTvTEvent.isPlayerParticipant(_owner.getObjectId()))
			{
				MultiTvTEventTeam enemyTeam = MultiTvTEvent.getParticipantEnemyTeam(_owner.getObjectId());
