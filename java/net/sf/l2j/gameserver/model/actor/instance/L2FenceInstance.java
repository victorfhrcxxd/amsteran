...
public final class L2FenceInstance extends L2Object
{
   ...
   public boolean isBetween(int x, int y, int tx, int ty) {
       ...
       boolean atLeastACross = crossLinePart(xMin,yMin,xMax,yMin,x,y,tx,ty) || crossLinePart(xMax,yMin,xMax,yMax,x,y,tx,ty) || crossLinePart(xMax,yMax,xMin,yMax,x,y,tx,ty) || crossLinePart(xMin,yMax,xMin,yMin,x,y,tx,ty);
