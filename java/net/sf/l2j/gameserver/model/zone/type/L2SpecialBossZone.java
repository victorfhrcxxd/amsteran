...
public class L2SpecialBossZone extends L2SpawnZone
{
	private boolean _enableScreenMessage;
	private String _screenMessageOnEnter;
	
	public L2SpecialBossZone(int id)
	{
		super(id);
	...
	{
		character.setInsideZone(ZoneId.SPECIAL_BOSS_AREA, true);
	...
	{
		character.setInsideZone(ZoneId.SPECIAL_BOSS_AREA, false);
