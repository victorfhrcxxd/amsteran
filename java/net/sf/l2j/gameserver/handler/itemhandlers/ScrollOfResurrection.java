...
public class ScrollOfResurrection implements IItemHandler
{
	...
	public void useItem(L2Playable playable, ItemInstance item, boolean forceUse)
	{
		...
		if (!MultiTvTEvent.onScrollUse(playable.getObjectId()) || !TvTEvent.onScrollUse(playable.getObjectId()) || !DMEvent.onScrollUse(playable.getObjectId()) || !KTBEvent.onScrollUse(playable.getObjectId()))
		{
