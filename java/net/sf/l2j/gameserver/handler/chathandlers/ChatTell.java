...
public class ChatTell implements IChatHandler
{
	...
	public void handleChat(int type, L2PcInstance activeChar, String target, String text)
	{
		...
		if (receiver != null)
		{
			...
			{
				activeChar.sendMessage("You cannot use this chat during an event.");
				return;
			}
			
			if (receiver.isInFunEvent())
			{
				activeChar.sendMessage("This character cannot receive PM at events.");
				return;
			}
