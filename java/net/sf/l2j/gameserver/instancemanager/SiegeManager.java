...
public class SiegeManager
{
	...
	public static int SIEGE_HOUR_SCHUTTGART;
	
	public static int NEXT_SIEGE_TIME;
	
	public static boolean SIEGE_ANTZERG_ENABLE;
	public static boolean SIEGE_HWID_PROTECT_ENABLE;
	public static int MAX_PLAYERS_BY_CLANALLY_ON_SIEGE;
	...
	protected SiegeManager()
	{
		...
		SIEGE_HOUR_GLUDIO = sieges.getProperty("SiegeHourGludio", 0);
		SIEGE_HOUR_DION = sieges.getProperty("SiegeHourDion", 0);
		SIEGE_HOUR_GIRAN = sieges.getProperty("SiegeHourGiran", 0);
		SIEGE_HOUR_OREN = sieges.getProperty("SiegeHourOren", 0);
		SIEGE_HOUR_ADEN = sieges.getProperty("SiegeHourAden", 0);
		SIEGE_HOUR_INNADRIL = sieges.getProperty("SiegeHourInnadril", 0);
		SIEGE_HOUR_GODDARD = sieges.getProperty("SiegeHourGoddard", 0);
		SIEGE_HOUR_RUNE = sieges.getProperty("SiegeHourRune", 0);
		SIEGE_HOUR_SCHUTTGART = sieges.getProperty("SiegeHourSchuttgart", 0);

		NEXT_SIEGE_TIME = sieges.getProperty("NextSiegeTime", 2);
		
		SIEGE_ANTZERG_ENABLE = sieges.getProperty("AllowSiegeAntZerg", false);
		SIEGE_HWID_PROTECT_ENABLE = sieges.getProperty("AllowSiegeHwidProtection", false);
		MAX_PLAYERS_BY_CLANALLY_ON_SIEGE = sieges.getProperty("MaxClanAllyMembersOnSiege", 10);
