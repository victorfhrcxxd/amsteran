...
import net.sf.l2j.gameserver.model.zone.type.L2HeavyZone;
import net.sf.l2j.gameserver.model.zone.type.L2OlympiadStadiumZone;
import net.sf.l2j.gameserver.model.zone.type.L2SpecialBossZone;
...
public class ZoneManager
{
	...
	public final static L2ChaoticSelfZone getChaos(L2Character character)
	{
		if (character == null)
			return null;
	...
	public final static L2SpecialBossZone getSpecialBoss(L2Character character)
	{
		if (character == null)
			return null;
		...
		for (L2ZoneType temp : ZoneManager.getInstance().getZones(character.getX(), character.getY(), character.getZ()))
		{
			if (temp instanceof L2SpecialBossZone && temp.isCharacterInZone(character))
				return ((L2SpecialBossZone) temp);
		}
		
		return null;
	}
	
	public final static L2HeavyZone getHeavyArea(L2Character character)
	{
		if (character == null)
			return null;
		...
		for (L2ZoneType temp : ZoneManager.getInstance().getZones(character.getX(), character.getY(), character.getZ()))
		{
			if (temp instanceof L2HeavyZone && temp.isCharacterInZone(character))
				return ((L2HeavyZone) temp);
		}
